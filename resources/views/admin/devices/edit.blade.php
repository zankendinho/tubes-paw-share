                    ...
                    <form action="{{ route('admin.devices.update', $device->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="kategori" id="kategori" 
                                ...
                                <option value="TV" {{ old('kategori', $device->kategori) == 'TV' ? 'selected' : '' }}>TV</option>
                                <option value="AC" {{ old('kategori', $device->kategori) == 'AC' ? 'selected' : '' }}>AC</option>
                                <option value="Laptop" {{ old('kategori', $device->kategori) == 'Laptop' ? 'selected' : '' }}>Laptop</option>
                                <option value="PC" {{ old('kategori', $device->kategori) == 'PC' ? 'selected' : '' }}>PC</option>
                                <option value="Kulkas" {{ old('kategori', $device->kategori) == 'Kulkas' ? 'selected' : '' }}>Kulkas</option>
                                <option value="Mesin Cuci" {{ old('kategori', $device->kategori) == 'Mesin Cuci' ? 'selected' : '' }}>Mesin Cuci</option>
                                <option value="Lainnya" {{ old('kategori', $device->kategori) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                            @error('kategori')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="merk" id="merk" value="{{ old('merk', $device->merk) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="tahun_beli" id="tahun_beli" value="{{ old('tahun_beli', $device->tahun_beli) }}" 
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="kondisi" id="kondisi" rows="3" 
                                class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('kondisi') border-red-500 @enderror">{{ old('kondisi', $device->kondisi) }}</textarea>
                            @error('kondisi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
